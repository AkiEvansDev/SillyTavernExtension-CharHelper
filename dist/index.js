...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.charHelperDataDescription {
    margin-top: 2px !important;
    margin-bottom: 2px !important;
}

@media (min-width: 1000px) {
    #charHelperPanelHolder {
        width: calc(var(--sheldWidth) - 2%);
    }

    .charHelperDataNumber {
        width: 20% !important;
    }

    .charHelperDataSelect {
        width: 40% !important;
    }
}

.charHelperDataSelect > option:disabled {
    color: #FFFFFF;
...
.charHelperGroupData:has(.charHelperDataNumber), .charHelperGroupData:has(.charHelperDataText) {
    margin-top: 0.4em;
    margin-bottom: 0.4em;
}
...
.charHelperSubGroup > div > .charHelperGroupData {
    margin-top: 0.4em;
    margin-bottom: 0.4em;
}
`, ""]);
...
/* harmony default export */ const common_Helper = (Helper);
;// CONCATENATED MODULE: ./src/common/StepData.js
...
class StepData {
  ...
  getSaveKey(key) {
    if (this.save.hasOwnProperty(key)) {
      let index = 0;
      let newKey = "".concat(key, "-").concat(index);
      while (this.save.hasOwnProperty(newKey)) {
        index++;
        newKey = "".concat(key, "-").concat(index);
      }
      return newKey;
    }
    return key;
  ...
  setGroups() {
    common_Helper.smartSplit(this.step['description'], ',').forEach((part, index) => {
      this.groups.push(this.getGroup(part, 'ch-group-' + this.stepIndex + '-' + index));
    });
  }
  getGroup(part, id) {
    let copy = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    let group = {
      id: id,
      title: part,
      items: []
    ...
    [...part.match(TEMPLATE_VALUE_REGEX)].forEach(key => {
      ...
      if (key.includes('?')) {
        let keys = common_Helper.smartSplit(key, '?').filter(k => k);
        if (keys.length === 1) {
  ...
  getData(group, key, addNone) {
    let copy = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    let copyParam = null;
    let replace = key;
    if (key.endsWith('*')) {
    ...
    if (key.startsWith('number-')) {
      type = 'number';
      title = common_Helper.titleCase(key.substring(7));
    } else if (key.startsWith('text-')) {
      type = 'text';
      title = common_Helper.titleCase(key.substring(5));
    }
    if (copy === true) {
      key = key + '-copy';
    }
  ...
  getResult() {
    ...
    return common_Helper.clearResult(result);
  }
...
/* harmony default export */ const common_StepData = (StepData);
;// CONCATENATED MODULE: ./src/common/StateManager.js
/* global SillyTavern */
/* global translate */
...
const RESOURCE_GROUP_REGEX = /^--[\w\- ]*$/g;
const RESOURCE_KEY_REGEX = /^- [\w\- ]*:/g;
class StateManager {
  static getData(name) {
    const context = SillyTavern.getContext();
    var result = lodash_default().get(context, "extensionSettings.charHelper.".concat(name), null);
    if (!result) result = DEFAULT[name];
    return result;
  }
  static setData(name, data) {
    const context = SillyTavern.getContext();
    lodash_default().set(context, "extensionSettings.charHelper.".concat(name), data);
  ...
  static getSteps() {
    ...
    let steps = [];
    let index = 0;
    common_Helper.smartSplit(template, '\n').forEach(function (line) {
      if (line && line.match(TEMPLATE_KEY_REGEX)) {
        let split = common_Helper.smartSplit(line, ':');
        if (split[1] && split[1].match(TEMPLATE_VALUE_REGEX)) {
          let data = new common_StepData(index, {
            title: split[0],
            description: split[1]
          }, resources);
          data.setGroups();
  ...
  static getResources() {
    ...
    let property = 0;
    let resources = {};
    common_Helper.smartSplit(resource, '\n').forEach(function (line) {
      if (line) {
        if (line.match(RESOURCE_GROUP_REGEX)) {
          part = common_Helper.keyCase(line.substring(2));
          key = null;
          header = 0;
          property = 0;
          ...
          if (key && header > 0) {
            resources[key].push({
              title: common_Helper.titleCase(split[0]),
              description: split[1],
              type: 'subTitle'
            });
            property = 0;
          } else {
            let title = common_Helper.titleCase(split[0]);
            let valueKey = common_Helper.keyCase(split[0]);
            if (part === valueKey) key = valueKey;else {
              title = common_Helper.titleCase(part) + ': ' + title;
              key = part + '-' + valueKey;
            }
            if (!resources.hasOwnProperty(key)) resources[key] = [];
            resources[key].push({
              title: title,
              description: split[1],
              type: 'title'
          ...
          if (split.length === 2) {
            resources[key].push({
              title: common_Helper.titleCase(value),
              value: common_Helper.keyCase(value),
              description: split[1],
              type: 'option'
            });
...
/* harmony default export */ const common_StateManager = (StateManager);
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(848);
;// CONCATENATED MODULE: ./src/parts/Select.js
...
function Select(_ref) {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)("select", {
    id: data['id'] + '-input',
    class: "charHelperDataSelect flex1 margin1",
    onChange: e => onChange(data, e.target.value),
    children: data['options'].map(option => /*#__PURE__*/(0,jsx_runtime.jsx)("option", {
      value: option['value'],
...
/* harmony default export */ const parts_Select = (Select);
;// CONCATENATED MODULE: ./src/parts/Number.js

function Number_Number(_ref) {
  let {
    data,
    onChange
  } = _ref;
  return /*#__PURE__*/(0,jsx_runtime.jsx)("input", {
    id: data['id'] + '-input',
    class: "charHelperDataNumber text_pole textarea_compact",
    type: "number",
    value: "0",
    min: "0",
    max: "1000",
...
/* harmony default export */ const parts_Number = (Number_Number);
;// CONCATENATED MODULE: ./src/parts/Text.js
...
function Text(_ref) {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)("textarea", {
    id: data['id'] + '-input',
    class: "charHelperDataText text_pole textarea_compact",
    rows: "2",
    onChange: e => onChange(data, e.target.value)
  });
}
/* harmony default export */ const parts_Text = (Text);
;// CONCATENATED MODULE: ./src/parts/Data.js
...
function Data(_ref) {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    id: data['id'],
    class: "charHelperGroupData",
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)("label", {
      for: data['id'] + "-input",
      children: data['title']
    }), /*#__PURE__*/(0,jsx_runtime.jsx)("p", {
      class: "charHelperDataDescription",
      children: /*#__PURE__*/(0,jsx_runtime.jsx)("small", {
        id: data['id'] + "-text",
        children: data['description'][stepData.save[data['id']]]
      })
    }), data['type'] === 'select' && /*#__PURE__*/(0,jsx_runtime.jsx)(parts_Select, {
      data: data,
      onChange: onChange
    }), data['type'] === 'number' && /*#__PURE__*/(0,jsx_runtime.jsx)(parts_Number, {
      data: data,
      onChange: onChange
    }), data['type'] === 'text' && /*#__PURE__*/(0,jsx_runtime.jsx)(parts_Text, {
      data: data,
      onChange: onChange
    }), data['subGroups'].map(subGroup => /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      class: "charHelperSubGroup",
      children: /*#__PURE__*/(0,jsx_runtime.jsx)(parts_Group, {
        stepData: stepData,
        group: subGroup,
        onChange: onChange
      })
...
/* harmony default export */ const parts_Data = (Data);
;// CONCATENATED MODULE: ./src/parts/Group.js
...
function Group(_ref) {
  ...
  function addCopy(data) {
    ...
    react_dom.render( /*#__PURE__*/(0,jsx_runtime.jsx)(parts_Data, {
      stepData: stepData,
      data: copy,
      onChange: onChange
    }), div);
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    ...
    }), group['items'].map(data => /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)(parts_Data, {
        stepData: stepData,
        data: data,
        onChange: onChange
      }), data['copyParam'] && /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          id: data['id'] + '-copy-container'
        }), /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
          class: "flex-container",
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
            class: "menu_button fa-plus fa-solid interactable",
            onClick: () => addCopy(data)
          }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
            class: "menu_button fa-minus fa-solid interactable",
            onClick: () => removeCopy(data)
          })]
        })]
      })]
    }))]
...
/* harmony default export */ const parts_Group = (Group);
;// CONCATENATED MODULE: ./src/Step.js
...
function Step(_ref) {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    id: 'charHelperStep-' + stepData.stepIndex,
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      class: "flex-container",
      children: [prev && /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        class: "menu_button interactable fa-solid fa-arrow-left",
        onClick: () => prev(stepData.stepIndex)
      }), next && /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        class: "menu_button interactable fa-solid fa-arrow-right",
        onClick: () => next(stepData.stepIndex)
      }), result && /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        class: "menu_button interactable fa-solid fa-check",
        onClick: () => result()
      })]
    }), /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      id: 'charHelperStep-' + stepData.stepIndex + '-container',
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)("h3", {
        children: stepData.step['title']
      }), /*#__PURE__*/(0,jsx_runtime.jsx)("hr", {}), stepData.groups.map(group => /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(parts_Group, {
          stepData: stepData,
          group: group,
          onChange: onChange
      ...
      class: "flex-container",
      children: [next && /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        ...
        onClick: () => result(),
        children: "Result"
      }), prev && /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        class: "menu_button interactable",
        onClick: () => prev(stepData.stepIndex),
        children: "Prev"
      })]
...
/* harmony default export */ const src_Step = (Step);
...
function App(_ref) {
  ...
  const [data, setData] = (0,react.useState)(common_StateManager.getSteps());
  const [wasRender, setRender] = (0,react.useState)(false);
  function refresh() {
    setData(common_StateManager.getSteps());
    let container = document.getElementById('charHelperPanelSteps');
    react_dom.render( /*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment, {}), container, () => {
      renderAll(() => {
        render(0);
      });
    });
  ...
  function result() {
    ...
    let text = common_Helper.buildResult(data['template'], data['steps']);
  ...
  function renderAll(complite) {
    ...
    let resultContainer = document.getElementById('charHelperPanelResult');
    resultContainer.style = 'display: none;';
    react_dom.render( /*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
      children: data['steps'].map((step, index) => /*#__PURE__*/(0,jsx_runtime.jsx)(src_Step, {
        stepData: step,
        next: index < data['steps'].length - 1 ? next : null,
        prev: index !== 0 ? prev : null,
        result: index === data['steps'].length - 1 ? result : null
      }))
    }), container, complite);
  }
  function render(index) {
    let hide = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    let container = document.getElementById('charHelperPanelSteps');
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      class: "panelControlBar flex-container alignItemsBaseline",
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        class: "fa-fw fa-solid fa-refresh floating_panel_close",
        onClick: () => refresh()
      }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        class: "fa-fw fa-solid fa-circle-xmark floating_panel_close",
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        id: "charHelperPanelSteps"
      }), /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        id: "charHelperPanelResult",
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          class: "flex-container",
          children: /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
            class: "menu_button interactable fa-solid fa-arrow-left",
          ...
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)("h3", {
            children: "Result:"
          }), /*#__PURE__*/(0,jsx_runtime.jsx)("hr", {}), /*#__PURE__*/(0,jsx_runtime.jsx)("textarea", {
            id: "charHelperPanelResult-input",
...
function Settings() {
  const [template, setTemplate] = (0,react.useState)(common_StateManager.getData('template'));
  const [resource, setResource] = (0,react.useState)(common_StateManager.getData('resource'));
  const [translate, seTranslate] = (0,react.useState)(common_StateManager.getData('translate'));
  const handleChangeTemplate = event => {
    setTemplate(event.target.value);
    common_StateManager.setData('template', event.target.value);
  };
  const handleChangeResource = event => {
    setResource(event.target.value);
    common_StateManager.setData('resource', event.target.value);
  };
  const handleChangeTranslate = event => {
    seTranslate(event.target.value);
    common_StateManager.setData('translate', event.target.value);
  };
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    class: "char_helper_settings",
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      class: "inline-drawer",
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        class: "inline-drawer-toggle inline-drawer-header",
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)("b", {
          "data-i18n": "ext_char_helper_title",
          children: "Char Helper"
        }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)("label", {
          for: "char_helper_template",
          class: "checkbox_label",
          "data-i18n": "ext_char_helper_template",
          children: "Template"
        }), /*#__PURE__*/(0,jsx_runtime.jsx)("textarea", {
          id: "char_helper_template",
          type: "text",
          class: "text_pole textarea_compact",
          rows: "5",
          placeholder: "",
          ...
          for: "char_helper_resource",
          class: "checkbox_label",
          "data-i18n": "ext_char_helper_resource",
          children: "Resource"
        }), /*#__PURE__*/(0,jsx_runtime.jsx)("textarea", {
          id: "char_helper_resource",
          type: "text",
          class: "text_pole textarea_compact",
          rows: "10",
          placeholder: "",
          ...
          class: "checkbox_label",
          for: "char_helper_translate",
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)("input", {
            type: "checkbox",
            id: "char_helper_translate",
            checked: translate,
...
root.render( /*#__PURE__*/(0,jsx_runtime.jsx)(react.StrictMode, {
  children: /*#__PURE__*/(0,jsx_runtime.jsx)(src_Settings, {})
}));
...
const rootWindow = client.createRoot(rootContainerWindow);
rootWindow.render( /*#__PURE__*/(0,jsx_runtime.jsx)(react.StrictMode, {
